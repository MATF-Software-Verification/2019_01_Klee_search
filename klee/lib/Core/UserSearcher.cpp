...
cl::opt<WeightedRandomSearcher::WeightType> TypeWRS(
    "type-wrs",
    cl::desc("Type for WeightedRandomSearcher for TargetSearcher"),
    cl::values(
        clEnumValN(WeightedRandomSearcher::Depth, "Depth", "Depth"),            
        clEnumValN(WeightedRandomSearcher::QueryCost, "QueryCost","QueryCost"),
        clEnumValN(WeightedRandomSearcher::InstCount, "InstCount","InstCount"),
        clEnumValN(WeightedRandomSearcher::CPInstCount, "CPInstCount","CPInstCount"),
        clEnumValN(WeightedRandomSearcher::MinDistToUncovered, "MinDistToUncovered","MinDistToUncovered"),
        clEnumValN(WeightedRandomSearcher::CoveringNew, "CoveringNew","CoveringNew")));
} // namespace
