...
namespace {
  ...
  cl::opt<std::string>
  TargetFunctionBFS("target-bfs",cl::desc("Target Functions for BFS"),cl::init(""));
  
  cl::opt<std::string>
  TargetFunctionWRS("target-wrs",cl::desc("Target Functions for WeightedRandomSearcher"),cl::init(""));
  
  cl::opt<std::string>
  TargetFunctionRPS("target-rps",cl::desc("Target Functions for RandomPathSearch"),cl::init(""));
  
  cl::opt<std::string>
  TargetFunctionRS("target-rs",cl::desc("Target Functions for RandomSearch"),cl::init(""));
